...
public class Song {
    ...
    /**
     * The song difficulty name
     */
    public String mDiffName;
    ...
    public Song(final long songId, final String dirPath, final String fileName, final String songName,
                final String diffName, final String artistName) {
        mSongId = songId;
        mDirPath = dirPath;
        mFileName = fileName;
        mSongName = songName;
