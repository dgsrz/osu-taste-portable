...
import com.andrew.apollo.loaders.DirectorySongLoader;
 ...
 */
public class DirectorySongFragment extends Fragment implements LoaderCallbacks<List<Song>>,
        OnItemClickListener {
    ...
    public void onItemClick(final AdapterView<?> parent, final View view, final int position,
        ...
        // Cursor cursor = AlbumSongLoader.makeAlbumSongCursor(getActivity(), getArguments().getLong(Config.ID));
        Cursor cursor = DirectorySongLoader.makeDirectorySongCursor(getActivity(), getArguments().getInt(Config.ID));
    ...
    public Loader<List<Song>> onCreateLoader(final int id, final Bundle args) {
        return new DirectorySongLoader(getActivity(), args.getInt(Config.ID));
    }
