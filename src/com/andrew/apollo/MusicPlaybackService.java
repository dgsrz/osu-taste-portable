...
import net.moesky.osuplayer.media.AudioPlayer;
...
public class MusicPlaybackService extends Service {
    ...
    private static final boolean D = true;  // TODO: 记得修改回来
     ...
     */
//    private static final String[] PROJECTION_DEPRECATED = new String[] {
...
//    };
    ...
    private static final String[] DIRECTORY_PROJECTION = new String[] {
            DirectoryStore.DirectoryColumns.DIRNAME, DirectoryStore.DirectoryColumns.ARTISTNAME
    };
    ...
    /**
     * 这个游标由于获取当前播放的osu文件所在文件夹的信息，比如下一个osu文件路径
     */
    private Cursor mDirectoryCursor;
    ...
    public void onCreate() {
        ...
        // TODO: 当存储卡被弹出的时候需要执行的操作，比如停止播放情理资源
        registerExternalStorageListener();

        // Initialize the media player
        // MultiPlayer已经被重写为使用BASSAudio播放
        mPlayer = new MultiPlayer(this, thread.getLooper());
    ...
    private void updateCursor(final String selection, final String[] selectionArgs) {
        synchronized (this) {
            ...
            mCursor = openCursorAndGoToFirst(PROJECTION, selection, selectionArgs);
        }
    ...
    private Cursor openCursorAndGoToFirst(String[] projection,
                                          String selection, String[] selectionArgs) {
        Cursor c = OsuFileStore
                .getInstance(getApplicationContext())
                .getReadableDatabase()
                .query(OsuFileStore.OsuFileColumns.NAME, projection,
    ...
    private void closeCursor() {
        ...
        if (mDirectoryCursor != null) {
            mDirectoryCursor.close();
            mDirectoryCursor = null;
        }
    }
    ...
    private void openCurrentAndMaybeNext(final boolean openNext) {
        synchronized (this) {
            ...
            while (true) {
                if (mCursor != null && openFile(getPath())) {
                    break;
                }
    ...
    public boolean openFile(final String path) {
        ...
        synchronized (this) {
            ...
            // FIXME: 假设不会发生这种异常
            if (mCursor == null) {
                if (D) Log.d(TAG, "Try to associate path = " + path);
                /*
                final ContentResolver resolver = getContentResolver();
                Uri uri;
                String where;
    ...
    public String getPath() {
        synchronized (this) {
            ...
            return getAlbumName() + "/" + mCursor.getString(mCursor.getColumnIndexOrThrow(
                    OsuFileStore.OsuFileColumns.FILENAME));
        }
    }
    ...
    public String getAlbumName() {
        synchronized (this) {
            ...
            return mCursor.getString(mCursor.getColumnIndexOrThrow(OsuFileStore.OsuFileColumns.DIRNAME));
        }
    }
    ...
    public String getTrackName() {
        synchronized (this) {
            ...
            return mCursor.getString(mCursor.getColumnIndexOrThrow(OsuFileStore.OsuFileColumns.SONGNAME));
        }
    }
    ...
    public String getArtistName() {
        synchronized (this) {
            ...
            return mCursor.getString(mCursor.getColumnIndexOrThrow(OsuFileStore.OsuFileColumns.ARTISTNAME));
        }
    }
...
//            return mCursor.getLong(mCursor.getColumnIndexOrThrow(AudioColumns.ALBUM_ID));
    ...
    private static final class MultiPlayer implements AudioPlayer.OnErrorListener,
        ...
        private AudioPlayer mCurrentMediaPlayer;

        //private AudioPlayer mNextMediaPlayer;  // 替换为字符串类型
        ...
        private boolean setDataSourceImpl(final AudioPlayer player, final String path) {
            try {
                ...
                if (D) Log.e(TAG, "Open beatmap failed");
                return false;
            }
        ...
        public void setNextDataSource(final String path) {
            mCurrentMediaPlayer.setNextDataSource(null);
            if (path == null) {
                return;
            }
            ...
            mCurrentMediaPlayer.setNextDataSource(mNextFilePath);
        }
         ...
         */
        @Override
        public boolean onError(final AudioPlayer mp, final int what, final int extra) {
            switch (what) {
         ...
         */
        @Override
        public void onCompletion(final AudioPlayer mp) {
            if (mp == mCurrentMediaPlayer && mp.hasNext()) {
                // mCurrentMediaPlayer.release();
                mCurrentMediaPlayer.switchToNext();
