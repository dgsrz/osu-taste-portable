...
public final class NavUtils {
    ...
    /**
     * Opens the profile of a directory.
     *
     * @param context The {@link Activity} to use.
     ...
     */
    public static void openDirectoryProfile(final Activity context,
                                        final String dirPath, final String artistName, final int dirId) {

        // Create a new bundle to transfer the album info
        final Bundle bundle = new Bundle();
        bundle.putString(Config.ALBUM_YEAR, MusicUtils.getReleaseDateForAlbum(context, dirId));
        bundle.putString(Config.ARTIST_NAME, artistName);
        bundle.putString(Config.MIME_TYPE, context.getString(R.string.directory));
        bundle.putInt(Config.ID, dirId);
        bundle.putString(Config.NAME, dirPath);
